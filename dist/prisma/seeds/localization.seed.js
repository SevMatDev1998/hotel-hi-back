...
exports.seedLocalization = seedLocalization;
    ...
    const localizationData = [
        {
            languageId: 2,
            key: 'AboutHeading',
            value: 'The FREE version of the HOTEL HAYV hotel management system allows you to create a price list in a very simple and accessible way, to share the price list and the terms of cooperation with partners, to automatically notify partners of changes in the price list.',
        },
        {
            languageId: 1,
            key: 'AboutHeading',
            value: 'ՀՈԹԵԼ ՀԱՅՎ հյուրանոցի կառավարման համակարգի ԱՆՎՃԱՐ տարբերակը հանարվորություն է տալիս ստեղծել գնացուցակ շատ պարզ և հասանելի տարբերակով կիսվել գնացուցակով և համագործակցության պայմաններով գործընկերների հետ ինքնաշխատ ծանուցել գործընկերներներին գնացուցակում կատարած փոփոխությունների մաին:\r\n',
        },
        ...
        { languageId: 1, key: 'RepeatPassword', value: 'Կրկնել գաղտնաբառը' },
        {
            ...
            value: 'The address has not yet been identified. Please pass the authentication sent to the email address',
        },
        {
            languageId: 1,
            key: 'EmailVerificationWasSentMessage',
            value: 'Էլ հասցեն նույնականացված չէ: Խնդրում ենք անցնել էլ հասցեին ուղարկված նույնականցումը ',
        },
        {
            languageId: 2,
            key: 'EmailVerifiedMessage',
            value: 'Your email address was confirmed, now you can login to your account',
        },
        ...
        },
        {
            ...
            value: 'You will have the opportunity to receive reservations during the mentioned period. Also to make changes through price regulation\r\n',
        },
        {
            languageId: 1,
            key: 'MainDetailsHeading2Info',
            value: 'Նշված ժամանակահատվածում վերապահումներ ստանալու հնարավորություն կունենաք։ Նաև գների կարգավորման միջոցով փոփոխություններ կատարել\r\n',
        },
...
//# sourceMappingURL=localization.seed.js.map