...
export class HotelFoodController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Hotel food service created successfully.',
  })
  ...
  findAll(
    @Query('hotelId', new ParseIntPipe({ optional: true })) hotelId?: number,
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Hotel food service retrieved successfully.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Hotel food service updated successfully.',
  })
  @ApiResponse({ status: 404, description: 'Hotel food service not found.' })
  update(
    @Param('hotelId', ParseIntPipe) hotelId: number,
  ...
  @ApiResponse({
    status: 200,
    description: 'Hotel food service deleted successfully.',
  })
  @ApiResponse({ status: 404, description: 'Hotel food service not found.' })
